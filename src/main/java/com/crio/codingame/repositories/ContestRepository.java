...
public class ContestRepository implements IContestRepository {
    ...
    public List<Contest> findAll() {
     return (List<Contest>)this.contestMap.values().stream().collect(Collectors.toList());
    }
    ...
    public List<Contest> findAllContestLevelWise(Level level) {
        return (List<Contest>)this.contestMap.values().stream().filter(i -> i.getLevel().equals(level)).collect(Collectors.toList());
    }
