...
public class QuestionRepository implements IQuestionRepository {
    ...
    public List<Question> findAll() {
      return (List<Question>)this.questionMap.values().stream().collect(Collectors.toList());
    }
    ...
    public List<Question> findAllQuestionLevelWise(Level level) {
        return (List<Question>)this.questionMap.values().stream().filter(i -> i.getLevel().equals(level)).collect(Collectors.toList());
    }
